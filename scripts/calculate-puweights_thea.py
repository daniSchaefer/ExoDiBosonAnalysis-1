...
parser = OptionParser()
parser.add_option('--data', '--data',action="store",type="string",dest="data",default="ExoDiBosonAnalysis.JetHT-2015D-triggerNEW.root")
parser.add_option('--mc', '--mc',action="store",type="string",dest="mc",default="ExoDiBosonAnalysis.qcd_puppi_triggerNEW.root")
...
fdata = TFile.Open(directory+options.data,'READ')
...
l.AddEntry(pudata,'Run 2015 D','PL')
